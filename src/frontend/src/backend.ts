...
import type { EnergyState as _EnergyState, ExportData as _ExportData, ExternalBlob as _ExternalBlob, ImportData as _ImportData, JournalEntry as _JournalEntry, MeditationSession as _MeditationSession, MeditationType as _MeditationType, MoodState as _MoodState, ProgressStats as _ProgressStats, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getCurrentUserExportData(): Promise<ExportData> {
        if (this.processError) {
            try {
                ...
                return from_candid_ExportData_n28(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async importData(arg0: ImportData, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.importData(await to_candid_ImportData_n30(this._uploadFile, this._downloadFile, arg0), arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_EnergyState_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _EnergyState): EnergyState {
    return from_candid_variant_n19(_uploadFile, _downloadFile, value);
}
async function from_candid_ExportData_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ExportData): Promise<ExportData> {
...
function from_candid_JournalEntry_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _JournalEntry): JournalEntry {
    return from_candid_record_n12(_uploadFile, _downloadFile, value);
}
function from_candid_MeditationType_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MeditationType): MeditationType {
    return from_candid_variant_n17(_uploadFile, _downloadFile, value);
}
function from_candid_MoodState_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MoodState): MoodState {
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        mood: from_candid_vec_n13(_uploadFile, _downloadFile, value.mood),
        user: value.user,
        isFavorite: value.isFavorite,
        timestamp: value.timestamp,
        reflection: value.reflection,
        meditationType: from_candid_MeditationType_n16(_uploadFile, _downloadFile, value.meditationType),
        energy: from_candid_EnergyState_n18(_uploadFile, _downloadFile, value.energy)
    };
}
...
async function from_candid_record_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        journalEntries: from_candid_vec_n10(_uploadFile, _downloadFile, value.journalEntries),
        progressStats: value.progressStats,
        sessionRecords: value.sessionRecords,
        userProfile: record_opt_to_undefined(await from_candid_opt_n20(_uploadFile, _downloadFile, value.userProfile))
    };
}
...
function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_JournalEntry>): Array<JournalEntry> {
    return value.map((x)=>from_candid_JournalEntry_n11(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MoodState>): Array<MoodState> {
    return value.map((x)=>from_candid_MoodState_n14(_uploadFile, _downloadFile, x));
}
function to_candid_EnergyState_n40(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: EnergyState): _EnergyState {
...
async function to_candid_ImportData_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ImportData): Promise<_ImportData> {
    return await to_candid_record_n31(_uploadFile, _downloadFile, value);
}
function to_candid_JournalEntry_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: JournalEntry): _JournalEntry {
    return to_candid_record_n34(_uploadFile, _downloadFile, value);
}
function to_candid_MeditationType_n38(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MeditationType): _MeditationType {
    return to_candid_variant_n39(_uploadFile, _downloadFile, value);
}
function to_candid_MoodState_n36(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MoodState): _MoodState {
...
async function to_candid_record_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        journalEntries: to_candid_vec_n32(_uploadFile, _downloadFile, value.journalEntries),
        progressStats: value.progressStats,
        sessionRecords: value.sessionRecords,
        userProfile: value.userProfile ? candid_some(await to_candid_UserProfile_n42(_uploadFile, _downloadFile, value.userProfile)) : candid_none()
    };
}
function to_candid_record_n34(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        duration: value.duration,
        mood: to_candid_vec_n35(_uploadFile, _downloadFile, value.mood),
        user: value.user,
        isFavorite: value.isFavorite,
        timestamp: value.timestamp,
        reflection: value.reflection,
        meditationType: to_candid_MeditationType_n38(_uploadFile, _downloadFile, value.meditationType),
        energy: to_candid_EnergyState_n40(_uploadFile, _downloadFile, value.energy)
    };
}
async function to_candid_record_n43(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        avatar: value.avatar ? candid_some(await to_candid_ExternalBlob_n44(_uploadFile, _downloadFile, value.avatar)) : candid_none()
    };
}
function to_candid_variant_n37(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MoodState): {
    sad: null;
} | {
    anxious: null;
} | {
...
function to_candid_variant_n39(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MeditationType): {
    ifs: null;
} | {
    metta: null;
} | {
...
function to_candid_variant_n41(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: EnergyState): {
    tired: null;
} | {
    energized: null;
} | {
...
function to_candid_vec_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<JournalEntry>): Array<_JournalEntry> {
    return value.map((x)=>to_candid_JournalEntry_n33(_uploadFile, _downloadFile, x));
}
function to_candid_vec_n35(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<MoodState>): Array<_MoodState> {
    return value.map((x)=>to_candid_MoodState_n36(_uploadFile, _downloadFile, x));
}
